...
QList<QRect> QtHelperCore::getScreenRects(bool available, bool full)
{
    QRect rect;
    QList<QRect> rects;
...
QRect QtHelperCore::getScreenRect(bool available, bool full)
{
...
QString QtHelperCore::getIniValue(char *argv[], const QString &key, const QString &dir, const QString &file)
{
    QString path, name;
...
QString QtHelperCore::checkPath(const QString &dirName)
{
    //相对路径需要补全完整路径
...
QString QtHelperCore::checkFile(const QString &fileName)
{
    //将相对路径转换成完整路径
