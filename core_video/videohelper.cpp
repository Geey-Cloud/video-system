...
void VideoHelper::getDevicePara(QString &mediaUrl, QString &bufferSize, int &frameRate, QString &codecName, int &offsetX, int &offsetY, float &encodeVideoRatio, QString &encodeVideoScale)
{
    ...
    DeviceInfoHelper::getDevicePara(mediaUrl, bufferSize, frameRate, codecName, offsetX, offsetY, encodeVideoRatio, encodeVideoScale);
...
MediaType VideoHelper::initPara(WidgetPara &widgetPara, VideoPara &videoPara, EncodePara &encodePara)
{
    ...
    if (mediaType == MediaType_Device || mediaType == MediaType_Screen) {
        VideoHelper::getDevicePara(videoPara.mediaUrl, videoPara.bufferSize, videoPara.frameRate, videoPara.codecName, videoPara.offsetX, videoPara.offsetY, encodePara.encodeVideoRatio, encodePara.encodeVideoScale);
    } else {
...
void VideoHelper::initVideoPara(VideoThread *videoThread, const QString &mediaUrl, float &encodeVideoRatio, QString &encodeVideoScale)
{
    ...
    if (mediaType == MediaType_Device || mediaType == MediaType_Screen) {
        ...
        int offsetX = 0;
        int offsetY = 0;
        VideoHelper::getDevicePara(deviceName, resolution, frameRate, codecName, offsetX, offsetY, encodeVideoRatio, encodeVideoScale);
