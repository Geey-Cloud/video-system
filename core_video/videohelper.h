...
public:
    ...
    static bool checkUrl(VideoThread *videoThread, const MediaType &mediaType, const QString &mediaUrl, int timeout = 500);
    ...
    //根据地址获取本地设备参数
    static void getDevicePara(QString &mediaUrl, QString &bufferSize, int &frameRate, QString &codecName, int &offsetX, int &offsetY, float &encodeVideoRatio, QString &encodeVideoScale);
    //根据地址获取通用地址参数
    static void getNormalPara(QString &mediaUrl, QString &transport, DecodeType &decodeType, EncodeVideo &encodeVideo, int &encodeVideoFps, float &encodeVideoRatio, QString &encodeVideoScale);
    ...
    static void initVideoPara(VideoThread *videoThread, const QString &mediaUrl, float &encodeVideoRatio, QString &encodeVideoScale);
};
