...
public:
    ...
    //初始化音频转换上下文
    static int initSwrContext(SwrContext **swrCtx, int out_channels, AVSampleFormat out_sample_fmt, int out_sample_rate, int in_channels, AVSampleFormat in_sample_fmt, int in_sample_rate);
    //初始化音频帧
