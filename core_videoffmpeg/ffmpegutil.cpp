...
void FFmpegUtil::getCodec(QStringList &listEncoderVideo, QStringList &listEncoderAudio, QStringList &listEncoderOther, QStringList &listDecoderVideo, QStringList &listDecoderAudio, QStringList &listDecoderOther)
{
...
void FFmpegUtil::debugAll(bool codec, bool protocol, bool other)
{
    if (codec) {
        ...
        FFmpegUtil::getCodec(listEncoderVideo, listEncoderAudio, listEncoderOther, listDecoderVideo, listDecoderAudio, listDecoderOther);
    }
