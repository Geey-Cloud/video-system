...
public:
    ...
    static void getCodec(QStringList &listEncoderVideo, QStringList &listEncoderAudio, QStringList &listEncoderOther, QStringList &listDecoderVideo, QStringList &listDecoderAudio, QStringList &listDecoderOther);
    //获取支持的输入输出协议
