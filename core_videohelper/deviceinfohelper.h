...
public:
    ...
    //添加音视频设备到下拉框
    static void initInputDevices(QComboBox *cboxAudioDevice, QComboBox *cboxVideoDevice, bool none = true);
    //获取音视频设备的参数
    ...
    static void getDevicePara(const QString &url, QString &resolution, int &frameRate, QString &codecName, int &offsetX, int &offsetY, float &encodeVideoRatio, QString &encodeVideoScale);
