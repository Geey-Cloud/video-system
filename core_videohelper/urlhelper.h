...
public:
    ...
    static QString getRtspUrl(const CompanyType &companyType, const QString &userName = QString("admin"), const QString &userPwd = QString("12345"), int channel = 0, int streamType = 0);
    ...
    //取出地址标识
    static QString getAddr(const QString &url);
