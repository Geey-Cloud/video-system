...
bool AppConfig::EnableChannely = true;
...
bool AppConfig::EnableMainVideo = true;
bool AppConfig::EnableMainMap = true;
bool AppConfig::EnableMainData = true;
bool AppConfig::EnableMainOther = false;

bool AppConfig::EnableMapImage = false;
bool AppConfig::EnableVideoPlayWeb = false;
bool AppConfig::EnableVideoPlayRtsp = true;
bool AppConfig::EnableVideoPlayImage = true;
bool AppConfig::EnableVideoUpload = false;
bool AppConfig::EnableDataDevice = true;
bool AppConfig::EnableConfigPoll = true;
bool AppConfig::EnableConfigUser = true;
bool AppConfig::EnableConfigRecord = true;
bool AppConfig::EnableConfigOther = true;

bool AppConfig::EnableWeather = false;
bool AppConfig::EnableVideoPanelTool = true;
bool AppConfig::EnableTitleMenu = true;
bool AppConfig::EnableDockMenu = true;
bool AppConfig::EnableDockMove = true;

bool AppConfig::EnableResolution = true;
bool AppConfig::EnableFrameRate = false;
bool AppConfig::EnableMediaUrl = false;
bool AppConfig::EnableFormatName = false;
bool AppConfig::EnableVideoCodecName = true;
bool AppConfig::EnableAudioCodecName = false;
bool AppConfig::EnableRealBitRate = false;
bool AppConfig::EnableHardware = false;
bool AppConfig::EnableVideoMode = false;
...
QString AppConfig::VideoNormalPath = "./video_normal";
QString AppConfig::VideoAlarmPath = "./video_alarm";
QString AppConfig::ImageNormalPath = "./image_normal";
QString AppConfig::ImageAlarmPath = "./image_alarm";
...
QString AppConfig::WeatherHttp = "http://www.nmc.cn";
QString AppConfig::WeatherCity = QString::fromUtf8("北京市|北京市|东城区");
int AppConfig::WeatherInterval = 60;
int AppConfig::WeatherStyle = 4;
