...
void BarVolume::drawBg(QPainter *painter)
{
    ...
    bgColorStart.setAlpha(bgColorAlpha);
    bgColorEnd.setAlpha(bgColorAlpha);;
...
int BarVolume::getBgColorAlpha() const
{
    return this->bgColorAlpha;
}

void BarVolume::setBgColorAlpha(int bgColorAlpha)
{
...
void BarVolume::setBgColorStart(const QColor &bgColorStart)
{
...
void BarVolume::setBgColorEnd(const QColor &bgColorEnd)
{
...
void BarVolume::setBarBgColor(const QColor &barBgColor)
{
...
void BarVolume::setBarColorStart(const QColor &barColorStart)
{
...
void BarVolume::setBarColorMid(const QColor &barColorMid)
{
...
void BarVolume::setBarColorEnd(const QColor &barColorEnd)
{
