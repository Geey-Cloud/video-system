...

{
    ...
    Q_PROPERTY(int bgColorAlpha READ getBgColorAlpha WRITE setBgColorAlpha)
...
public:
    ...
    //获取和设置背景颜色透明度
    int getBgColorAlpha() const;
    void setBgColorAlpha(int bgColorAlpha);
    ...
    void setBarColorMid(const QColor &barColorMid);
